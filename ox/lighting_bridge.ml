...
let () =
  Callback.register "cd_compute_headlight_light_d1"
    cd_compute_headlight_light_d1;
  Callback.register "cd_compute_headlight_light_d2"
    cd_compute_headlight_light_d2

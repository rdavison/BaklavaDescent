...
## What Was Ported (21 Worklog Entries)
...
### Physics/Collision
- **FVI**: check_line_to_face, special_check_line_to_face, check_vector_to_sphere_1
...
1. **Global state entanglement** (~10 functions): Access Objects[], Segments[], Players[], Robot_info[], Walls[], GameBitmaps[] etc. in ways that can't be cleanly extracted as scalar callsite args. Examples: `do_physics_align_object`, `apply_damage_to_robot` D2, `compute_headlight_light` D2, `check_vector_to_object`.
